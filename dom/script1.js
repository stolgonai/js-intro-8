...
const alertMessag = window.alert("This is alert message!");
console.log("Name is ", name);
console.log("This is an alert message ", alertMessag);
*/

/*
// Confirm ---
const userAnswer = window.confirm("Do you want to contimue?");
...
*/
/*
console.log("innerHeight", innerHeight); //783
console.log("innerWidth", innerWidth); //754
*/
...
console.log(reloadPage, "this is reload happening");
